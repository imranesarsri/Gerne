  ...
  return (
    <main className="flex items-center justify-center min-h-[80vh] w-full p-4">
      <div className="w-full max-w-[400px] bg-card-bg backdrop-blur-xl border border-glass-border p-10 rounded-3xl shadow-2xl animate-in slide-in-from-bottom-5 duration-500">
        ...
        <h2 className="text-2xl font-bold mb-8 text-center text-slate-200">Welcome Back</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-2">
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 bg-slate-900/50 border border-glass-border rounded-xl text-white transition-all focus:outline-none focus:border-primary focus:bg-slate-900/70 focus:ring-4 focus:ring-primary/10"
            />
          </div>
          <div className="space-y-2">
          ...
          <button 
            type="submit" 
            className="w-full py-3.5 bg-primary text-white font-bold rounded-xl hover:bg-primary-hover active:scale-95 transition-all outline-none shadow-lg shadow-primary/20 hover:shadow-primary/40 mt-2"
            disabled={loading}
          >
        ...
        <div className="mt-8 text-center text-sm text-slate-400">
          Don't have an account? <Link href="/signup" className="text-primary hover:text-primary-hover font-semibold transition-colors">Sign up</Link>
        </div>
      </div>
    </main>
  );
